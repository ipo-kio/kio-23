...
const sourceFolders = [path.join(__dirname, "tasks"), path.join(__dirname, "node_modules")];
...
module.exports = function (env) {
  ...
  if (production) config = merge(config, productionConfig);
  else config = merge(config, debugConfig);
